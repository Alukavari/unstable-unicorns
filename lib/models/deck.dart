...
final List<CardModel> babyDeck = [
  CardModel(
      ...
      CardClass.baby,
      'assets/baby_unicorn/1m.png',
      '1m'),
  CardModel(
      'Baby',
      'Если ты должен принести в жертву, уничтожить или вернуть на руку малыша-единорожка, вместо этого помести его в ясли',
      CardClass.baby,
      'assets/baby_unicorn/2m.png',
      '2m'),
  CardModel(
      'Baby',
      'Если ты должен принести в жертву, уничтожить или вернуть на руку малыша-единорожка, вместо этого помести его в ясли',
      CardClass.baby,
      'assets/baby_unicorn/.png',
      '3m'),
  CardModel(
      'Baby',
      'Если ты должен принести в жертву, уничтожить или вернуть на руку малыша-единорожка, вместо этого помести его в ясли',
      CardClass.baby,
      'assets/baby_unicorn/4m.png',
      '4m'),
  CardModel(
      'Baby',
      'Если ты должен принести в жертву, уничтожить или вернуть на руку малыша-единорожка, вместо этого помести его в ясли',
      CardClass.baby,
      'assets/baby_unicorn/5m.png',
      '5m'),
  CardModel(
      'Baby',
      'Если ты должен принести в жертву, уничтожить или вернуть на руку малыша-единорожка, вместо этого помести его в ясли',
      CardClass.baby,
      'assets/baby_unicorn/6m.png',
      '6m'),
];
...
final List<CardModel> cards = [
  ...
  CardModel(
      'КОФЕЙНЫЙ ДЕБОШ',
      'В начале своего хода можешь принести в жертву1 карту, а затем взять 2 карты',
      CardClass.bonus,
      'assets/10b.png',
      '10b'),
  ...
  CardModel(
      'МИНИ-СТОЙЛО',
      'Каждый раз, когда в твоём стойле оказывается больше 5 единорожковприноси в жертву 1 единорожка',
      CardClass.fine,
      'assets/5ff.png',
      '2ff'),
  ...
  CardModel(
      'АМЕРИРОГ',
      'Когда этот единорожек входит в твое стойло, можешь случайным образом взять1 карту с руки другого игрока',
      CardClass.unicorn,
      'assets/9.pngu',
      '9u'),
  CardModel(
  ...
  CardModel(
      'ВОЛШЕБНЫЙ КРЫЛОРОГ',
      'Когда этот единорожек входит в твоё стойло, можешь взять на руку1 заклинание из стопки сброса. Если волшебный крылорог оказывается принесен в жертву или уничтожен, верни его на руку.',
      CardClass.unicorn,
      'assets/17u.png',
      '17u'),
  CardModel(
  ...
  CardModel(
      'ПОЧАТОК РОГ',
      'Когда этот единорожек входит в твое стойло, возьми 2 карты и сбрось1 карту (необязательно из взятых)',
      CardClass.unicorn,
      'assets/21u.png',
      '21u'),
  CardModel(
...
// update deck
 ...
 //get player deck finee/effects/bonuses..
