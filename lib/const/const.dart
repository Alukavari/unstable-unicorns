...
TextStyle textForScroll = GoogleFonts.ribeye(fontWeight: FontWeight.w700, fontSize: 13, color: bgColor);
TextStyle textForFB = GoogleFonts.ribeye(fontWeight: FontWeight.w700, fontSize: 10, color: Colors.white);
